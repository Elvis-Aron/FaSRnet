...
class DefaultTrainer(BaseExecutor):
    ...
    def train(self):
        ...
        for epoch in range(self.begin_epoch, self.end_epoch):
            ...
            self.core_function.train(model=self.model, epoch=epoch,
                                     optimizer=self.optimizer, dataloader=self.dataloader,
            ...
            writer.add_scalar('learning_rate', self.lr_scheduler.get_last_lr(), epoch)
