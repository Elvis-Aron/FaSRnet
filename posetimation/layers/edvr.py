...
class TSAFusion(nn.Module):
    ...
    def forward(self, aligned_feat):
        ...
        for i in range(t):
            ...
            # 相邻特征与 当前特征相乘 计算相似权重 只是得到相同位置与相同位置之间的相似度
...
class EDVR(nn.Module):
    ...
    def forward(self, x):
        ...
        feat = self.fusion(aligned_feat)  # 特征融合
